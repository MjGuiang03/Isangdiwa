...
function buildTopNSeriesData({
  seriesKeys,       // string[] ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â all community/province names
...
const ChartFooter = ({ period, location, generatedAt }) => (
  <div className="mt-2 pt-2 border-t border-slate-100 dark:border-white/5 text-center">
    <p className="m-0 font-inter text-[10px] text-slate-400 dark:text-slate-500">Source: IsangDiwa · {period} · {location}</p>
    {generatedAt && (
      <>
        <p className="m-0 font-inter text-[10px] font-semibold text-slate-500 dark:text-slate-400 mt-0.5">Generated by IsangDiwa AI · {new Date(generatedAt).toLocaleString('en-US', { year: 'numeric', month: 'numeric', day: 'numeric', hour: 'numeric', minute: '2-digit', hour12: true })}</p>
        <p className="m-0 font-inter text-[9px] text-slate-400 dark:text-slate-500 mt-0.5">This report was generated using artificial intelligence. Please verify critical data points before making decisions.</p>
      </>
    )}
  </div>
);
...
export default function AdminFinancialReport() {
  ...
  useEffect(() => {
    if (report) {
      ...
      } catch { /* quota exceeded ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ignore */ }
    }
  ...
  return (
    <div className="flex flex-col p-6 max-w-[1400px] mx-auto w-full min-h-screen bg-slate-100 dark:bg-[#161922] font-inter text-slate-800 dark:text-slate-200 gap-6">
      ...
      {/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Specific Communities Selector ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ */}
      ...
      {/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Skeleton Loading State ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ */}
      {loading && (
      ...
      {error && !loading && (
        <div className="p-6 bg-rose-50 text-rose-700 dark:bg-rose-500/10 dark:text-rose-400 border border-rose-200 dark:border-rose-500/20 rounded-xl font-inter text-sm flex items-center gap-3">
          <p>ÃƒÂ¢Ã…Â¡Ã‚Â ️ {error}</p>
          <button onClick={generateReport}>Try Again</button>
        </div>
      )}

      {/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Report Content ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ */}
      {report && !loading && (
        <div className="flex flex-col gap-3.5" ref={reportRef}>
          ...
          {/* Executive Summary (Only for non-secretary paper reports) */}
          {report.executiveSummary && !report.secretary && (
            <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden p-4 sm:p-4.5 flex flex-col gap-3 pdf-page-card">
              <div className="px-4 py-2.5 border-b border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/20 flex items-center justify-between -mx-4 -mt-4">
                <div className="px-2 py-0.5 bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400 rounded text-[10.5px] font-bold uppercase tracking-wider flex items-center gap-1.5">
                  <Sparkles size={13} />
            ...
            <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden p-6 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {report.comparison.donations && (() => {
                  ...
                  return (
                    <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-5 flex flex-col justify-between gap-3 min-h-[320px] h-auto">
                      <h3 className="m-0 font-inter text-[15px] font-bold text-slate-800 dark:text-white">Donations ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Period Over Period</h3>
                ...
                {report.comparison.attendance && (() => {
                  ...
                  return (
                    <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-5 flex flex-col justify-between gap-3 min-h-[320px] h-auto">
                      <h3 className="m-0 font-inter text-[15px] font-bold text-slate-800 dark:text-white">Attendance ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Period Over Period</h3>
                      <p className="font-inter text-[13px] text-slate-500 dark:text-slate-400 mt-1">
              ...
              {report.comparison.loans && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" style={{marginTop: '16px'}}>
                  <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-5 flex flex-col justify-between gap-3 min-h-[320px] h-auto">
                    <h3 className="m-0 font-inter text-[15px] font-bold text-slate-800 dark:text-white">Loans ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Period Over Period</h3>
                    <p className="font-inter text-[13px] text-slate-500 dark:text-slate-400 mt-1">
              ...
              {report.comparison.disbursements && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" style={{marginTop: '16px'}}>
                  <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-5 flex flex-col justify-between gap-3 min-h-[320px] h-auto">
                    <h3 className="m-0 font-inter text-[15px] font-bold text-slate-800 dark:text-white">Disbursements ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Period Over Period</h3>
                    <p className="font-inter text-[13px] text-slate-500 dark:text-slate-400 mt-1">
          ...
          {report.donations && adminRole === 'admin' && (report.reportType === 'all' || report.reportType === 'donations') && (
            <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden p-6 flex flex-col gap-6">
                ...
                {(() => {
                  ...
                  return (
                    <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-5 flex flex-col justify-between gap-3 min-h-[320px] h-auto">
                      ...
                      <p className="font-inter text-[13px] text-slate-500 dark:text-slate-400 mt-1">Total: <strong>{fmt(totalDon)}</strong> · Highest: <strong>{highestMon?.month} ({fmt(highestMon?.value || 0)})</strong>{topDonCommName ? <> · Top Community: <strong>{topDonCommName} ({fmt(topDonCommVal)})</strong></> : null}</p>
              ...
              {(() => {
                ...
                // ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Å“ NEW: limit to top 10
                const { from, to } = getChartMonthRange();
                ...
                return (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" style={{ gridTemplateColumns: '1fr', marginTop: '16px' }}>
                    <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-6 flex flex-col min-h-[400px] h-auto justify-between" style={{ width: '100%' }}>
                      ...
                      {/* Legend ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â grouped by province */}
                      {(() => {
                        const branchToProv = {};
                        branchesData.forEach(b => {
                      ...
                      {hasOthers && (
                        <p className="block font-inter text-xs text-slate-400 dark:text-slate-500 mt-2 text-center">
                          ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¹️ Chart shows top 10 communities by total donation. {otherSeries.length} smaller communities
                ...
                return fullMonthData.some(d => topSeries.some(k => d[k] > 0)) ? (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" style={{ gridTemplateColumns: '1fr', marginTop: '16px' }}>
                    <div className="bg-white dark:bg-[#1E2130] rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-6 flex flex-col min-h-[400px] h-auto justify-between" style={{ width: '100%' }}>
                      ...
                      {hasOthers && (
                        <p className="block font-inter text-xs text-slate-400 dark:text-slate-500 mt-2 text-center">
                          ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¹️ Chart shows top 10 communities by total attendance. {otherSeries.length} smaller
          ...
          {/* Loans Section - Only for Loan Admin ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â A4 Paper Format */}
          {report.loans && adminRole === 'loanAdmin' && (
            <React.Fragment>

              {/* PAGE 1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Loan Portfolio Executive Overview */}
              ...
              {/* PAGE 2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Loan Trends & Analysis */}
              ...
              {/* PAGE 3 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Savings Overview */}
              {report.savings && (
              <div className="a4-page a4-page-break" style={a4Style}>
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #0D1F45', paddingBottom: '8px', marginBottom: '4px' }}>
                  ...
                  {/* Savings Charts */}
                  <div style={{ display: 'grid', gridTemplateColumns: '3fr 7fr', gap: '8px', flex: 1 }}>
                    {/* Goals Donut */}
                        ...
                        <thead>
                          <tr style={{ background: '#f8fafc' }}>
                            {['#', 'Member', 'Community', 'Service', 'Date', 'Time In', 'Status'].map(h => (
                              <th key={h} style={{ padding: '5px 8px', borderBottom: '1px solid #e2e8f0', textAlign: 'left', fontWeight: 700, fontSize: '9px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.04em' }}>{h}</th>
                            ))}
                          </tr>
                        </thead>
                        <tbody>
                          {pageRows.map((a, i) => (
                            <tr key={i} style={{ borderBottom: '1px solid #f1f5f9' }}>
                              <td style={{ padding: '4px 8px', color: '#6b7280' }}>{pageIdx * ROWS_PER_PAGE + i + 1}</td>
                              <td style={{ padding: '4px 8px', fontWeight: 600, color: '#0f172a' }}>{a.name}</td>
                              <td style={{ padding: '4px 8px', color: '#374151' }}>{a.branch}</td>
                              <td style={{ padding: '4px 8px', color: '#374151' }}>{a.service}</td>
                              <td style={{ padding: '4px 8px', color: '#374151' }}>{a.date}</td>
                              <td style={{ padding: '4px 8px', color: '#374151' }}>{a.time}</td>
                              <td style={{ padding: '4px 8px' }}>
                                <span style={{ fontSize: '9px', padding: '2px 6px', borderRadius: '3px', background: a.status === 'Present' ? '#dcfce7' : '#fee2e2', color: a.status === 'Present' ? '#166534' : '#991b1b', fontWeight: 600 }}>{a.status}</span>
                              </td>
                            </tr>
                          ))}
                        </tbody>
                    ...
                    return trendData.length > 0 ? (
                      <div style={{ border: '1px solid #e2e8f0', borderRadius: '0px', padding: '14px', display: 'flex', flexDirection: 'column', gap: '6px', width: '100%' }}>
                        ...
                        {isMulti && (() => {
                          ...
                          return (
                            <div className="pdf-avoid-break mt-4 pt-3 border-t border-slate-100 dark:border-white/5" style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '12px 16px', marginTop: '16px' }}>
                              {Object.entries(seriesByProv).map(([prov, seriesList]) => {
                                const activeSeries = seriesList.filter(s => s.hasData);
                                if (activeSeries.length === 0) return null;
                                return (
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[2000] flex items-center justify-center p-4" onClick={() => setShowConfirm(false)}>
          <div className="bg-white dark:bg-[#1E2130] rounded-2xl w-full max-w-[500px] shadow-2xl p-6 flex flex-col items-center text-center" onClick={e => e.stopPropagation()}>
            ...
            <p className="m-0 font-inter text-sm text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">Please review the details below before proceeding. AI report generation may take 10ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“15 seconds.</p>
